...
public class OpenTelemetryConfig {
  ...
  // @Bean
  // OpenTelemetry openTelemetry (SdkLoggerProvider sdkLoggerProvider, SdkTracerProvider
  // sdkTracerProvider, ContextPropagators contextPropagators) {
  ...
  //     Resource springResource = Resource.create(Attributes.of(ResourceAttributes.SERVICE_NAME,
  // applicationName));
  ...
  //                             .setEndpoint(otelExporterOtplEndpoint)
  //                             .build())
  //             .build();
  // }

  // @Bean
  // OtlpHttpSpanExporter otlpHttpSpanExporter(@Value("${management.otlp.tracing.endpoint}") String
  // url) {
