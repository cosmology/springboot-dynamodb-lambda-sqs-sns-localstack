package com.ivanprokic.sportticketconsumer.util;

import ch.qos.logback.classic.spi.ILoggingEvent;
import org.springframework.boot.json.JsonWriter;
import org.springframework.boot.logging.structured.StructuredLogFormatter;

public class StructuredLoggingJsonFormatter implements StructuredLogFormatter<ILoggingEvent> {
      ...
      JsonWriter.<ILoggingEvent>of(
              (members) -> {
                ...
                members
                    ...
                    .usingMembers(
                        (application) -> {
                          application.add("name", "SportTicketConsumerApplication");
